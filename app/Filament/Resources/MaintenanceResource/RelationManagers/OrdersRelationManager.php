        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ->label(__('dashboard.status'))
                    ->formatStateUsing(fn ($state) => $state instanceof OrderStatusEnum ? $state->label() : \App\Enum\OrderStatusEnum::tryFrom($state)?->label() ?? '-')
                    ->sortable()
                    ->searchable(),
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ->mutateFormDataUsing(function (array $data): array {
                        $data['maintenance_id'] = $this->getOwnerRecord()->id;
